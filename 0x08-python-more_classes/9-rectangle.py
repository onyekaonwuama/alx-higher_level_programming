...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Represents the Rectangle with the greater area.
        Args:
            rect_1 (Rectangle): Rectangle one.
            rect_2 (Rectangle): Rectangle two.
        Raises:
            TypeError: If either of rect_1 or rect_2 is not an object Rectangle.
        """
    ...
    def square(cls, size=0):
        """Return a new Rectangle object with width and height equal to size.
        Args:
            size (int): The width and height of the new Rectangle object
        """
    ...
    def __del__(self):
        """Print a message for each Rectangle destroyed."""
        type(self).number_of_instances -= 1
        print("Bye rectangle...")
