...
'''
    Defining test cases for the base module
'''
...
class test_base(unittest.TestCase):
    ...
    def test_id_negative_number(self):
        '''
    ...
    def test_id_string(self):
        '''
            Sending a string as id
        '''
        b = Base("Miss")
        self.assertEqual("Miss", b.id)
